...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制	
	protected $config  =	array('header'=>'条记录','prev'=>'&laquo; 上一页','next'=>'下一页 &raquo;','first'=>'&laquo; 首页','last'=>'末页 &raquo;','theme'=>' <div class="row pagination"><div class="span2">%totalRow% %header% %nowPage%/%totalPage% 页</div><div class="span8"><div><ul><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li></ul></div></div> ');
    // 默认分页变量名
    protected $varPage;
